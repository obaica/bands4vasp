...
USE MATH
 ...
 TYPE :: PARAMETERS
   ...
   INTEGER,DIMENSION(2) :: KSKIP,SION
   REAL(DP) :: FBORDER, TRASH, WDIF, EDIF, EGAP, DBLOCH
   ...
   LOGICAL :: BAND=.TRUE.,BANDPLOT=.TRUE.,ROOTSCALC=.TRUE.
   LOGICAL :: POLY=.FALSE.,LBAV=.FALSE.,LOAV=.TRUE.,NORM=.FALSE.
   LOGICAL :: SPECFUN=.TRUE.,SYMREC=.TRUE.,SLIMSPEC=.TRUE.
 END TYPE PARAMETERS
